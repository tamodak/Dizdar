 ...
 *
 * [KillitBlue] is the one approximation: `oklch(75% 0.16 230)` falls outside the sRGB gamut, so it
 ...
 */
val KillitGreenTint = KillitGreen.copy(alpha = 0.12f)
val KillitRedTint = KillitRed.copy(alpha = 0.12f)
